...
1. Clone the repository:git clone [https://github.com/Nishaanth419/travel_AI.git](https://github.com/Nishaanth419/travel_AI.git) 
...
<!--- Eraser file: https://app.eraser.io/workspace/ITHfX2CmBRfVZimKKniY ---># travel_AI
# travel_AI
